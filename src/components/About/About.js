      ...
      <div className="text">
        ...
        <div className="about-me">
          <p>
            ...
            get motivated in striving to be the best at what I do. If you need
            a website for your business, company or yourself; are looking to
            redesign your website or just user experience scroll to check out
            some of my projects below. Below are the languages and
